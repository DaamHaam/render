...
async function getCompletion(content) {
    ...
    let texteEtape = " est ma réponse. Ta tâche est à nouveau de répondre au format JSON : écris la suite de l'histoire en quatre à six lignes, puis propose moi 3 choix d'actions A) B) C) pour la suite. Pour information il restera " + nombreDeQuestionsRestantes + " questions ensuite, donc adapte l'intensité du scénario (préparer la fin 2 questions avant). La réponse doit être uniquement en structure JSON, répartie dans les clés suivantes : histoire, choixA, choixB, choixC."
    let texteDeFin = " est ma réponse. Ta tâche est à nouveau de répondre au format JSON : c'est la fin de l'histoire il faut la conclure l'histoire, sans proposer de nouveaux choix. La réponse doit contenir uniquement la clé histoire dans la structure JSON."
